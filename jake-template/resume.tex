...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Improved the notification service through infrastructure improvements and minimal impact. This signficantly decreased delivery latency from 2 hours to less than 1 min during peak hours.}
      \resumeItem{Led the effort in finalzing a \textbf{Postgres} ORM by conducting POCs and upskilling peers on its use.}
      ...
      \resumeItem{Built a API comparison system in to perform shadow testing of API.  This improved confidence of code changes being performed as part of the migration.}
    \resumeItemListEnd
