...
\vspace{\topsep} % hacky fix to prevent list from overlapping with location
\begin{tightemize}
...
\end{tightemize}
% justifying\noindent Maintainer of CMS-Android, an open source Moodle client for Android. The app is a vital part of student academics,
...
\begin{tightemize}
 ...
 \item Facilitated 150,000+ transactions worth approx.\rupee1.5 million (\$22,000).
\end{tightemize}
\primarysectionsep  % end of section
